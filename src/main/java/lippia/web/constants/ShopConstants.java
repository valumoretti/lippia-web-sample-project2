...
public class ShopConstants {
    ...
    public static final String ANDROID_BREADCRUMB_NAV = "path://nav[contains(@class, 'woocommerce-breadcrumb') and contains(text(), 'Android')]";
    ...
    public static final String SELENIUM_BREADCRUMB_NAV = "//nav[contains(@class, 'woocommerce-breadcrumb') and contains(text(), 'selenium')]";
